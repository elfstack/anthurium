                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'id'">{{ trans('admin.budget.columns.id') }}</th>
                                        <th is='sortable' :column="'activity_id'">{{ trans('admin.budget.columns.activity_id') }}</th>
                                        <th is='sortable' :column="'budget_category_id'">{{ trans('admin.budget.columns.budget_category_id') }}</th>
                                        <th is='sortable' :column="'budget'">{{ trans('admin.budget.columns.budget') }}</th>
                                        <th is='sortable' :column="'expense'">{{ trans('admin.budget.columns.expense') }}</th>
                                        <th is='sortable' :column="'name'">{{ trans('admin.budget.columns.name') }}</th>
