...
class FillPermissionsForBudgetCategory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBudgetCategory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.budget-category',
            'admin.budget-category.index',
            'admin.budget-category.create',
            'admin.budget-category.show',
            'admin.budget-category.edit',
            'admin.budget-category.delete',
            'admin.budget-category.bulk-delete',
        ]);
